...
/**
 * UserKoperasiSearch represents the model behind the search form of `frontend\models\UserKoperasi`.
 */
class UserKoperasiSearch extends UserKoperasi
{
    ...
    public function rules()
    {
        return [
            ...
            [['koperasi_name', 'koperasi_holder_name', 'koperasi_holder_phone', 'koperasi_email', 'koperasi_password', 'koperasi_address', 'koperasi_lat', 'koperasi_lng'], 'safe'],
        ];
    }
